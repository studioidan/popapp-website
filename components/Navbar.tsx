      ...
      {menuOpen && (
        <div className="hide-desktop" style={{
          ...
          <button onClick={() => go('contact')} style={{
            marginTop: 32, background: 'linear-gradient(135deg, #00e5ff, #0077ff)',
            color: '#04070f', border: 'none', padding: '16px',
            borderRadius: 12, fontFamily: 'inherit', fontSize: '1.1rem', fontWeight: 700, cursor: 'pointer',
          }}>בואו נדבר →</button>
        </div>
      )}
